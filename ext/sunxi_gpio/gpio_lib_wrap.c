...
#define SWIG_init    Init_gpio_lib
#define SWIG_name    "Gpio_lib"

static VALUE mGpio_lib;
...
extern "C"
#endif
SWIGEXPORT void Init_gpio_lib(void) {
  size_t i;
  
  SWIG_InitRuntime();
  mGpio_lib = rb_define_module("Gpio_lib");
  ...
  rb_define_singleton_method(mGpio_lib, "SUNXI_PIO_BASE", _wrap_SUNXI_PIO_BASE_get, 0);
  rb_define_singleton_method(mGpio_lib, "SUNXI_PIO_BASE=", _wrap_SUNXI_PIO_BASE_set, 1);
  rb_define_module_function(mGpio_lib, "sunxi_gpio_input", _wrap_sunxi_gpio_input, -1);
  rb_define_module_function(mGpio_lib, "sunxi_gpio_init", _wrap_sunxi_gpio_init, -1);
